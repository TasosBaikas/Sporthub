...
import com.baikas.sporthub6.viewmodels.settings.UserGeneralNotificationsActivityViewModel;
import com.google.firebase.auth.FirebaseAuth;

import dagger.hilt.android.AndroidEntryPoint;

@AndroidEntryPoint
public class UserGeneralNotificationsActivity extends AppCompatActivity {

    ProgressBar loadingBar;
    UserGeneralNotificationsActivityViewModel viewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(UserGeneralNotificationsActivityViewModel.class);
        ...
        viewModel.getLoadGeneralUserNotificationsLiveData().observe(this,(NotificationOptions generalNotifications) -> {
            ...
            notificationsBeforeMatch.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                viewModel.updateGeneralUserNotification(generalNotifications, yourId)
                        .observe(UserGeneralNotificationsActivity.this, (unused -> {
                            loadingBar.setVisibility(View.GONE);

                            ToastManager.showToast(UserGeneralNotificationsActivity.this, "Επιτυχής αλλαγή", Toast.LENGTH_SHORT);
                        }));
            });
            ...
            frameLayout.setOnClickListener((View layoutClick) -> {
                ...
                viewModel.updateGeneralUserNotification(notificationOptions,yourId)
                        .observe(UserGeneralNotificationsActivity.this, (unused -> {
                            ...
                            ToastManager.showToast(UserGeneralNotificationsActivity.this, "Η αναβολή ορίστηκε", Toast.LENGTH_SHORT);
                        }));
