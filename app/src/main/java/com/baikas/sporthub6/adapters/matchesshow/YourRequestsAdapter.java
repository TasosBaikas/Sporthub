...
public class YourRequestsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public YourRequestsAdapter(List<Match> mainMatches, OnClickJoinMatch onClickJoinMatch,
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NotNull View view) {
            ...
            sportImage = view.findViewById(R.id.sport_image);//only for youRequests else it is null
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_team_1v1_your_requests, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        realViewHolder.player1.profileImage.setOnClickListener(new Prevent2ClicksListener() {
            ...
            public void onClickExecuteCode(View v) {
                ...
                onClickSeeProfileOfUserListener.openUserProfile(match.getAdmin().getUserId(), match.getSport());
            }
        });
        ...
        realViewHolder.sportImage.setImageResource(SportConstants.SPORTS_MAP.get(match.getSport()).getSportImageId());

        realViewHolder.viewSmallLine.setBackgroundColor(ContextCompat.getColor(realViewHolder.itemView.getContext(), SportConstants.SPORTS_MAP.get(match.getSport()).getSportColor()));
