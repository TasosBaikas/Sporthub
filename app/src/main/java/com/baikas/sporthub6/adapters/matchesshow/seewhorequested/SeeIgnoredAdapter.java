...
public class SeeIgnoredAdapter extends RecyclerView.Adapter<SeeIgnoredAdapter.ViewHolder>{
    ...
    public SeeIgnoredAdapter(List<User> usersThatRequested, Match currentMatch, OnClickListenerPass2CompletableFuture<String, JoinOrIgnore> onClick, OpenUserProfile onClickSeeProfileOfUserListener) {

        if (usersThatRequested == null)
            this.usersThatRequested = new ArrayList<>();
        else
            this.usersThatRequested = new ArrayList<>(usersThatRequested);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NotNull View view) {
            ...
            // Button
            requestJoin = view.findViewById(R.id.request_join);
        }
    ...
    @NotNull
    @Override
    public SeeIgnoredAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {

        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_see_ignored_one, viewGroup, false);

        return new SeeIgnoredAdapter.ViewHolder(view);
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(@NonNull SeeIgnoredAdapter.ViewHolder viewHolder, final int position) {
        ...
        viewHolder.requestJoin.setOnClickListener((View buttonClicked)->{
