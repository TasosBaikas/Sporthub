...
export const matchRepositoryAdminAcceptsUser = functions.region('europe-west1').https.onCall(async (data: any, context: any) => {
    ...
    try {
        ...
        const userToAccept:string = parsedSnapshot.userToAccept;
        ...
        const matchToReturn:Match = await matchRepository.adminAcceptsUser(userToAccept,adminId,matchId,sport);
