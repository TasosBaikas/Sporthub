...
export const matchRepositoryUserJoinOrCancelRequestForMatch = functions.region('europe-west1').https.onCall(async (data: any, context: any) => {
    ...
    try {
        ...
        const matchToReturn:Match = await matchRepository.userJoinOrCancelRequestForMatch(yourId,matchId,sport);
