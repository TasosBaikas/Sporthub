...
export const matchRepositoryUserOnlyJoinMatch = functions.region('europe-west1').https.onCall(async (data: any, context: any) => {
    ...
    try {
        ...
        await matchRepository.userOnlyJoinMatch(yourId,matchId,sport);
