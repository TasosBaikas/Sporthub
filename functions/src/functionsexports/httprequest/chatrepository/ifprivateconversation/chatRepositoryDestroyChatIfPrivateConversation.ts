...
export const chatRepositoryDestroyChatIfPrivateConversation = functions.region('europe-west1').https.onCall(async (data: any, context: any) => {
    ...
    try {
        ...
        await chatRepository.destroyChatIfPrivateConversation(yourId,chatId);
