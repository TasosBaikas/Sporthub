...
export const chatRepositoryDeletePinnedMessage = functions.region('europe-west1').https.onCall(async (data: any, context: any) => {
    ...
    try {
        ...
        await chatRepository.deletePinnedMessage(chatMessage, yourId);
