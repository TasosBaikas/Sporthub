...
export const chatMessageRepositoryChangeSeenBy = functions.region('europe-west1').https.onCall(async (data: any, context: any) => {
    ...
    try {
        ...
        await chatMessageRepository.changeSeenByUser(chatMessage,yourId);
